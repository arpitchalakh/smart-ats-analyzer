...
export default function DashboardPage(){
  ...
  return <div className="app-shell">
    ...
    <main className="app-main">
      ...
      {view==='Dashboard'&&<Dashboard credits={credits} jd={jd} setJd={setJd} file={file} setFile={setFile} jobTitle={jobTitle} setJobTitle={setJobTitle} company={company} setCompany={setCompany} loading={loading} error={error} analyze={analyze} result={result} setResult={setResult}/>} 
